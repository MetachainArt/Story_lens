...
export type TemplateCollectionId = 'all' | 'modern' | 'daily' | 'travel' | 'family' | 'occasion' | 'playful';
export type TemplateCollection = Exclude<TemplateCollectionId, 'all'>;
...
export const PHOTOBOOK_TEMPLATE_COLLECTIONS: Array<{
  ...
  { id: 'daily', label: '일상' },
  { id: 'travel', label: '여행' },
  { id: 'family', label: '가족·성장' },
  { id: 'occasion', label: '기념' },
  { id: 'playful', label: '재미' },
];

export const PHOTOBOOK_TEMPLATES: PhotoBookTemplate[] = [
  {
    id: 'minimal', name: '모던 화이트', category: '깔끔한 앨범', collection: 'modern', mark: '01',
  ...
  {
    id: 'magazine', name: '에디토리얼 매거진', category: '잡지 형식', collection: 'modern', mark: 'M',
  ...
  {
    id: 'polaroid', name: '포토 스티커', category: '귀여운 앨범', collection: 'daily', mark: '✦',
  ...
  {
    id: 'cinematic', name: '시네마 화보', category: '감성 화보', collection: 'modern', mark: '35',
  ...
  {
    id: 'diary', name: '마이 다이어리', category: '기록 앨범', collection: 'daily', mark: 'N',
  ...
  {
    id: 'gallery', name: '아트 갤러리', category: '전시 앨범', collection: 'modern', mark: 'A',
  ...
  {
    id: 'storybook', name: '꿈꾸는 동화책', category: '이야기 앨범', collection: 'playful', mark: '★',
  ...
  {
    id: 'scrapbook', name: '컬러 스크랩북', category: '활기찬 앨범', collection: 'playful', mark: 'CUT',
  ...
  {
    id: 'travel', name: '트래블 저널', category: '여행 앨범', collection: 'travel', mark: 'GO',
  ...
  {
    id: 'family', name: '패밀리 앨범', category: '가족 앨범', collection: 'family', mark: '家',
  ...
  {
    id: 'city-magazine', name: '시티 트래블 매거진', category: '도시 여행', collection: 'travel', mark: 'CITY',
  ...
  {
    id: 'baby', name: '베이비 첫 기록', category: '성장 앨범', collection: 'family', mark: 'BABY',
  ...
  {
    id: 'wedding', name: '웨딩 클래식', category: '기념 앨범', collection: 'occasion', mark: 'VOW',
  ...
  {
    id: 'yearbook', name: '우리들의 이어북', category: '학교·모임', collection: 'occasion', mark: '26',
  ...
  {
    id: 'pet', name: '반려동물 스토리', category: '반려 앨범', collection: 'family', mark: 'PAW',
  ...
  {
    id: 'season', name: '사계절 컬렉션', category: '계절 앨범', collection: 'daily', mark: '4S',
  ...
  {
    id: 'recipe', name: '우리집 레시피', category: '음식 기록', collection: 'daily', mark: 'RECIPE',
  ...
  {
    id: 'retro', name: '레트로 필름 로그', category: '필름 감성', collection: 'daily', mark: '24',
  ...
  {
    id: 'comic', name: '포토 코믹북', category: '재미있는 앨범', collection: 'playful', mark: 'WOW',
  ...
  {
    id: 'celebration', name: '생일 파티북', category: '축하 앨범', collection: 'occasion', mark: 'HBD',
  ...
  {
    id: 'botanical', name: '내추럴 보태니컬', category: '자연 감성', collection: 'daily', mark: 'LEAF',
    description: '잎사귀와 햇살을 닮은 편안한 자연 기록', previewBg: '#F2F1E8', previewAccent: '#365E48',
    previewSecondary: '#B5A36A', layout: 'season', layoutSequence: ['hero', 'duo', 'collage'], decorations: ['🌿', '○', '☀'], isNew: true,
  },
  {
    id: 'monochrome', name: '블랙 앤 화이트', category: '흑백 화보', collection: 'modern', mark: 'B&W',
    description: '색을 덜어 사진의 표정에 집중한 미니멀 화보', previewBg: '#181818', previewAccent: '#F2F2EE',
    previewSecondary: '#767672', layout: 'art', layoutSequence: ['hero', 'story-strip', 'duo'], decorations: ['—', '●', '□'], isDark: true, isNew: true,
  },
  {
    id: 'hanok', name: '한옥의 하루', category: '한국 여행', collection: 'travel', mark: '韓',
    description: '고즈넉한 색감과 여백으로 담는 우리 여행', previewBg: '#F0E8DA', previewAccent: '#6C3D2E',
    previewSecondary: '#294B45', layout: 'travel', layoutSequence: ['duo', 'hero', 'story-strip'], decorations: ['⌂', '梅', '—'], isNew: true,
  },
  {
    id: 'ocean', name: '오션 블루', category: '바다 여행', collection: 'travel', mark: 'SEA',
    description: '파도와 수평선을 닮은 시원한 여름 화보', previewBg: '#E9F5F7', previewAccent: '#185B74',
    previewSecondary: '#E68B60', layout: 'city', layoutSequence: ['hero', 'trio', 'grid4'], decorations: ['≈', '☀', '○'], isNew: true,
  },
  {
    id: 'camping', name: '캠핑 로그', category: '주말 여행', collection: 'travel', mark: 'CAMP',
    description: '숲과 불빛, 함께한 밤을 담는 아웃도어 기록', previewBg: '#E9E6D8', previewAccent: '#31513D',
    previewSecondary: '#C5683F', layout: 'scrapbook', layoutSequence: ['collage', 'hero', 'duo'], decorations: ['△', '🔥', '★'], isNew: true,
  },
  {
    id: 'graduation', name: '졸업 컬렉션', category: '졸업·입학', collection: 'occasion', mark: 'GRAD',
    description: '새로운 출발과 빛나는 순간을 담는 기념 앨범', previewBg: '#EEF1F7', previewAccent: '#243B6B',
    previewSecondary: '#D5A742', layout: 'yearbook', layoutSequence: ['grid4', 'hero', 'story-strip'], decorations: ['★', '✓', '∞'], isNew: true,
  },
  {
    id: 'friendship', name: '우정 스냅', category: '친구 앨범', collection: 'family', mark: 'BFF',
    description: '친구와 웃었던 순간을 생생하게 모은 스냅북', previewBg: '#FFF0EA', previewAccent: '#B54B58',
    previewSecondary: '#427E86', layout: 'family', layoutSequence: ['collage', 'duo', 'grid4'], decorations: ['♡', '✦', '☺'], isNew: true,
  },
  {
    id: 'music', name: '뮤직 플레이리스트', category: '음악 앨범', collection: 'playful', mark: 'PLAY',
    description: '좋아하는 노래처럼 장면이 이어지는 리듬 화보', previewBg: '#181727', previewAccent: '#B9F35D',
    previewSecondary: '#9C6BFF', layout: 'cinema', layoutSequence: ['story-strip', 'hero', 'trio'], decorations: ['▶', '♫', '●'], isDark: true, isNew: true,
  },
];
